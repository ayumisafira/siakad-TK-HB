                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="<?= $mahasiswa['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jenis_kelamin" value="<?= $mahasiswa['jenis_kelamin']; ?>" class="form-control" id="jenis_kelamin" placeholder="Jenis Kelamin">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="prodi" value="<?= $mahasiswa['prodi']; ?>" class="form-control" id="prodi" placeholder="Prodi">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp" value="<?= $mahasiswa['asal_sekolah']; ?>" class="form-control" id="no_hp" placeholder="No HP">
                        </div>
                        <div class="form-group">
